...
export const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
    return (
        <footer className="bg-slate-950 text-white mt-auto border-t border-slate-800">
            <div className="max-w-7xl mx-auto px-6 py-16 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div className="col-span-1 md:col-span-2">
                    ...
                    <p className="text-slate-400 text-sm leading-relaxed max-w-sm mb-6">
                        Une démarche de préfiguration pour créer un socle commun de gouvernance, d’interopérabilité et de connaissances en vue d’un futur Data Space filière.
                    </p>
                ...
                <div>
                    ...
                    <ul className="space-y-3">
                        <li><button onClick={() => onNavigate('/le-consortium')} className="text-slate-400 hover:text-emerald-400 text-sm">Gouvernance & Charte</button></li>
                ...
                <div>
                    ...
                    <ul className="space-y-3">
                        ...
                        <li><button onClick={() => onNavigate('/ressources')} className="text-slate-400 hover:text-emerald-400 text-sm">Documentation</button></li>
